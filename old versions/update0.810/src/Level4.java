...
public class Level4 extends JPanel {
	...
	protected CatBoss cat3 = new CatBoss();
	...
	public void paint(Graphics g)
	{
		...
		if(cat3.catgoestoright)
		{
			if(cat3.catattack)
			{
				g.drawImage(CatBoss.bosscatrightattack, cat3.catX, cat3.catY,250 ,250,null);
			}
			else
			{
				g.drawImage(CatBoss.bosscatright, cat3.catX, cat3.catY,250 ,250,null);
			}
		}
		else
		{
			if(cat3.catattack)
			{
				g.drawImage(CatBoss.bosscatleftattack, cat3.catX, cat3.catY,250 ,250,null);
			}
			else
			{
				g.drawImage(CatBoss.bosscatleft, cat3.catX, cat3.catY,250 ,250,null);
			}	
		}
