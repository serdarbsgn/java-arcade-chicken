...
public class Game extends JPanel implements ActionListener,KeyListener{
	...
	{		
			resolutionx=resx;
			resolutiony=resy;
			l1 = new Level(1,0,0,true,resolutionx,resolutiony);
			l2 = new Level(1,1,0,false,resolutionx,resolutiony);
			l3 = new Level(1,2,0,false,resolutionx,resolutiony);
			l4 = new Level(1,1,1,false,resolutionx,resolutiony);
			m  = new MainMenu(resolutionx,resolutiony);
			lose = new LoseScreen(resolutionx,resolutiony);
			addKeyListener(this);
			setFocusable(true);
		...
		{		
				if(m.level==1)
				{
					...
					if(play==false)
					{
						...
						g.drawString("GAME IS PAUSED PRESS ESC TO CONTINUE/PAUSE", resolutionx/5 , resolutiony/3 );
						g.drawString("BACKSPACE TO MAIN MENU", resolutionx/5 , (int)(resolutiony/2.2) );
					}
				...
				if(m.level==2)
				{
					...
					if(play==false)
					{
						...
						g.drawString("GAME IS PAUSED PRESS ESC TO CONTINUE/PAUSE", resolutionx/5 , resolutiony/3 );
						g.drawString("BACKSPACE TO MAIN MENU", resolutionx/5 , (int)(resolutiony/2.5) );
					}
